        ...
        <div className='px-4 py-10 bg-white'>
            <div className='flex justify-center items-center'>
                <div className='w-10 h-10 bg-yellow-300 flex justify-center items-center rounded-full'>
                    {
                        image == "BsBuildings" ? <BsBuildings className='w-6 h-6'/> : image == "TbBeach" ? <TbBeach className='w-6 h-6'/> : 
                        image == "TbSailboat" ? <TbSailboat className='w-6 h-6'/> : image == "TbEyeSearch" ? <TbEyeSearch className='w-6 h-6'/> :
                        image == "CiForkAndKnife" ? <CiForkAndKnife className='w-6 h-6'/> : image == "TbMountain" ? <TbMountain className='w-6 h-6'/> :
